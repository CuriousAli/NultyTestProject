...
class ProjectPage(BasePage):
    ...
    def appereance_of_the_list_of_clients(self):
        ...
        sector_menu = self.browser.find_element(*ProjectsPageLocators.CLIENT_SELECTION_BAR_STATUS_LOCATOR)
        assert "selectric-open" in sector_menu.get_attribute("class"), "Client's menu hasn't been opened"
